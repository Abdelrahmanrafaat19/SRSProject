...
namespace SRSProject.Infrastructure.Migrations
{
    ...
    [Migration("20260919142107_Policy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SRSProject.Domain.Entities.CompanySettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SRSProject.Domain.Entities.PayrollAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SRSProject.Domain.Entities.WeekHolidayEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.PrimitiveCollection<string>("DaysOfHoliday")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SRSProject.Infrastructure.OfficialHolidayEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SRSProject.Domain.Entities.EmployeeEntity", b =>
                {
                    b.HasOne("SRSProject.Domain.Entities.WeekHolidayEntity", "WeekHoliday")
                        .WithMany()
            ...
            modelBuilder.Entity("SRSProject.Domain.Entities.PayrollAdjustment", b =>
                {
                    b.HasOne("SRSProject.Domain.Entities.PayrollRecord", "PayrollRecord")
